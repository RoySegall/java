...
public class BusStopTester {
	...
	public static void main(String[] args) {
        ...
        // add arrival time
        busStop.add(firstBusArrival.getLineNum(), 
        		    firstBusArrival.getNoOfPass(), 
        		    firstBusArrival.getArrivalTime());

        busStop.add(secondBusArrival.getLineNum(), 
    		    	secondBusArrival.getNoOfPass(), 
    		    	secondBusArrival.getArrivalTime());
